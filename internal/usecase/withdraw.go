...
func (u Usecase) CreateWithdraw(walletAddress string, wr structure.WithDrawItemRequest) (*entity.Withdraw, error) {
	logger.AtLog.Logger.Info("CreateWithdraw", zap.String("walletAddress", walletAddress), zap.Any("input", wr))
...
func (u Usecase) CreateWithdrawProject(walletAddress string, wr structure.WithDrawItemRequest) (*entity.Withdraw, error) {
	...
	logger.AtLog.Logger.Info("CreateWithdrawProject", zap.String("walletAddress", walletAddress), zap.Any("input", wr))
	...
	logger.AtLog.Logger.Info("CreateWithdraw.volumes", zap.String("walletAddress", walletAddress), zap.Any("volumes", volumes))
	...
	logger.AtLog.Logger.Info("CreateWithdraw.CreateWithDraw", zap.String("walletAddress", walletAddress), zap.Any("widthdraw", f))
...
func (u Usecase) CreateWithdrawReferral(walletAddress string, wr structure.WithDrawItemRequest) (*entity.Withdraw, error) {
	...
	logger.AtLog.Logger.Info("CreateWithdrawReferral", zap.String("walletAddress", walletAddress), zap.Any("input", wr))
	volumeAmount := 0.0 //earning
	widthDrawAmount := 0.0
	requestEarnings, err := strconv.ParseFloat(wr.Amount, 10)
	if err != nil {
...
func (u Usecase) UpdateRefObject(withdraw entity.Withdraw) {
	logger.AtLog.Logger.Info("UpdateRefObject", zap.Any("withdraw", withdraw))
	...
	case entity.WithDrawReferal:
		...
		logger.AtLog.Logger.Info("UpdateRefObject.UpdateReferral", zap.Any("updated", updated))
		break
	}
}
