...
func (h *httpDelivery) generateMessageUpdate(w http.ResponseWriter, r *http.Request) {
	...
	message, err := h.Usecase.GenerateMessageUpdate(structure.GenerateMessage{
...
func (h *httpDelivery) verifyMessageUpdate(w http.ResponseWriter, r *http.Request) {
	...
	verified, err := h.Usecase.VerifyMessageUpdate(verifyMessage)
