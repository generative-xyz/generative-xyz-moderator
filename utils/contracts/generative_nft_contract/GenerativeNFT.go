...
// Reserves is a free data retrieval call binding the contract method 0xac4fb5f4.
//
// Solidity: function _reserves(address ) view returns(bool)
func (_GenerativeNftContract *GenerativeNftContractCaller) Reserves(opts *bind.CallOpts, arg0 common.Address) (bool, error) {
	var out []interface{}
	err := _GenerativeNftContract.contract.Call(opts, &out, "_reserves", arg0)
...
//
// Solidity: function _reserves(address ) view returns(bool)
func (_GenerativeNftContract *GenerativeNftContractSession) Reserves(arg0 common.Address) (bool, error) {
	return _GenerativeNftContract.Contract.Reserves(&_GenerativeNftContract.CallOpts, arg0)
}

// Reserves is a free data retrieval call binding the contract method 0xac4fb5f4.
//
// Solidity: function _reserves(address ) view returns(bool)
func (_GenerativeNftContract *GenerativeNftContractCallerSession) Reserves(arg0 common.Address) (bool, error) {
	return _GenerativeNftContract.Contract.Reserves(&_GenerativeNftContract.CallOpts, arg0)
}
...
func (_GenerativeNftContract *GenerativeNftContractCaller) TokenIdToHash(opts *bind.CallOpts, tokenId *big.Int) ([32]byte, error) {
	var out []interface{}
	err := _GenerativeNftContract.contract.Call(opts, &out, "tokenIdToHash", tokenId)
...
//
// Solidity: function tokenIdToHash(uint256 tokenId) view returns(bytes32)
func (_GenerativeNftContract *GenerativeNftContractSession) TokenIdToHash(tokenId *big.Int) ([32]byte, error) {
	return _GenerativeNftContract.Contract.TokenIdToHash(&_GenerativeNftContract.CallOpts, tokenId)
}

// TokenIdToHash is a free data retrieval call binding the contract method 0x621a1f74.
//
// Solidity: function tokenIdToHash(uint256 tokenId) view returns(bytes32)
func (_GenerativeNftContract *GenerativeNftContractCallerSession) TokenIdToHash(tokenId *big.Int) ([32]byte, error) {
	return _GenerativeNftContract.Contract.TokenIdToHash(&_GenerativeNftContract.CallOpts, tokenId)
}
...
// Mint is a paid mutator transaction binding the contract method 0x5d6ffda7.
//
// Solidity: function mint(address to, bytes[] chunks) payable returns(uint256 tokenId)
func (_GenerativeNftContract *GenerativeNftContractTransactor) Mint(opts *bind.TransactOpts, to common.Address, chunks [][]byte) (*types.Transaction, error) {
	return _GenerativeNftContract.contract.Transact(opts, "mint", to, chunks)
}

// Mint is a paid mutator transaction binding the contract method 0x5d6ffda7.
//
// Solidity: function mint(address to, bytes[] chunks) payable returns(uint256 tokenId)
func (_GenerativeNftContract *GenerativeNftContractSession) Mint(to common.Address, chunks [][]byte) (*types.Transaction, error) {
	return _GenerativeNftContract.Contract.Mint(&_GenerativeNftContract.TransactOpts, to, chunks)
}

// Mint is a paid mutator transaction binding the contract method 0x5d6ffda7.
//
// Solidity: function mint(address to, bytes[] chunks) payable returns(uint256 tokenId)
func (_GenerativeNftContract *GenerativeNftContractTransactorSession) Mint(to common.Address, chunks [][]byte) (*types.Transaction, error) {
	return _GenerativeNftContract.Contract.Mint(&_GenerativeNftContract.TransactOpts, to, chunks)
}
...
// ReserveMint is a paid mutator transaction binding the contract method 0xf038ba72.
//
// Solidity: function reserveMint(address to, bytes[] chunks) payable returns(uint256 tokenId)
func (_GenerativeNftContract *GenerativeNftContractTransactor) ReserveMint(opts *bind.TransactOpts, to common.Address, chunks [][]byte) (*types.Transaction, error) {
	return _GenerativeNftContract.contract.Transact(opts, "reserveMint", to, chunks)
}

// ReserveMint is a paid mutator transaction binding the contract method 0xf038ba72.
//
// Solidity: function reserveMint(address to, bytes[] chunks) payable returns(uint256 tokenId)
func (_GenerativeNftContract *GenerativeNftContractSession) ReserveMint(to common.Address, chunks [][]byte) (*types.Transaction, error) {
	return _GenerativeNftContract.Contract.ReserveMint(&_GenerativeNftContract.TransactOpts, to, chunks)
}

// ReserveMint is a paid mutator transaction binding the contract method 0xf038ba72.
//
// Solidity: function reserveMint(address to, bytes[] chunks) payable returns(uint256 tokenId)
func (_GenerativeNftContract *GenerativeNftContractTransactorSession) ReserveMint(to common.Address, chunks [][]byte) (*types.Transaction, error) {
	return _GenerativeNftContract.Contract.ReserveMint(&_GenerativeNftContract.TransactOpts, to, chunks)
}
...
// Store is a paid mutator transaction binding the contract method 0xa933024e.
//
// Solidity: function store(uint256 tokenId, uint256 chunkIndex, bytes _data) returns()
func (_GenerativeNftContract *GenerativeNftContractTransactor) Store(opts *bind.TransactOpts, tokenId *big.Int, chunkIndex *big.Int, _data []byte) (*types.Transaction, error) {
	return _GenerativeNftContract.contract.Transact(opts, "store", tokenId, chunkIndex, _data)
}

// Store is a paid mutator transaction binding the contract method 0xa933024e.
//
// Solidity: function store(uint256 tokenId, uint256 chunkIndex, bytes _data) returns()
func (_GenerativeNftContract *GenerativeNftContractSession) Store(tokenId *big.Int, chunkIndex *big.Int, _data []byte) (*types.Transaction, error) {
	return _GenerativeNftContract.Contract.Store(&_GenerativeNftContract.TransactOpts, tokenId, chunkIndex, _data)
}

// Store is a paid mutator transaction binding the contract method 0xa933024e.
//
// Solidity: function store(uint256 tokenId, uint256 chunkIndex, bytes _data) returns()
func (_GenerativeNftContract *GenerativeNftContractTransactorSession) Store(tokenId *big.Int, chunkIndex *big.Int, _data []byte) (*types.Transaction, error) {
	return _GenerativeNftContract.Contract.Store(&_GenerativeNftContract.TransactOpts, tokenId, chunkIndex, _data)
}
...
//
// Solidity: function updatePrice(uint256 price) returns()
func (_GenerativeNftContract *GenerativeNftContractTransactor) UpdatePrice(opts *bind.TransactOpts, price *big.Int) (*types.Transaction, error) {
	return _GenerativeNftContract.contract.Transact(opts, "updatePrice", price)
}

// UpdatePrice is a paid mutator transaction binding the contract method 0x8d6cc56d.
//
// Solidity: function updatePrice(uint256 price) returns()
func (_GenerativeNftContract *GenerativeNftContractSession) UpdatePrice(price *big.Int) (*types.Transaction, error) {
	return _GenerativeNftContract.Contract.UpdatePrice(&_GenerativeNftContract.TransactOpts, price)
}

// UpdatePrice is a paid mutator transaction binding the contract method 0x8d6cc56d.
//
// Solidity: function updatePrice(uint256 price) returns()
func (_GenerativeNftContract *GenerativeNftContractTransactorSession) UpdatePrice(price *big.Int) (*types.Transaction, error) {
	return _GenerativeNftContract.Contract.UpdatePrice(&_GenerativeNftContract.TransactOpts, price)
}

// UpdatePriceAddress is a paid mutator transaction binding the contract method 0x6e8a6d12.
//
// Solidity: function updatePriceAddress(address mintPriceAddress) returns()
func (_GenerativeNftContract *GenerativeNftContractTransactor) UpdatePriceAddress(opts *bind.TransactOpts, mintPriceAddress common.Address) (*types.Transaction, error) {
	return _GenerativeNftContract.contract.Transact(opts, "updatePriceAddress", mintPriceAddress)
}

// UpdatePriceAddress is a paid mutator transaction binding the contract method 0x6e8a6d12.
//
// Solidity: function updatePriceAddress(address mintPriceAddress) returns()
func (_GenerativeNftContract *GenerativeNftContractSession) UpdatePriceAddress(mintPriceAddress common.Address) (*types.Transaction, error) {
	return _GenerativeNftContract.Contract.UpdatePriceAddress(&_GenerativeNftContract.TransactOpts, mintPriceAddress)
}

// UpdatePriceAddress is a paid mutator transaction binding the contract method 0x6e8a6d12.
//
// Solidity: function updatePriceAddress(address mintPriceAddress) returns()
func (_GenerativeNftContract *GenerativeNftContractTransactorSession) UpdatePriceAddress(mintPriceAddress common.Address) (*types.Transaction, error) {
	return _GenerativeNftContract.Contract.UpdatePriceAddress(&_GenerativeNftContract.TransactOpts, mintPriceAddress)
}
