...
//
// Solidity: function _project() view returns(address _projectAddr, uint256 _projectId, uint24 _maxSupply, uint24 _limit, uint24 _index, uint24 _indexReserve, string _creator, uint256 _mintPrice, address _mintPriceAddr, string _name, (uint256,uint256) _mintingSchedule)
...
// Init is a paid mutator transaction binding the contract method 0xeb03558a.
//
// Solidity: function init((address,uint256,uint24,uint24,uint24,uint24,string,uint256,address,string,(uint256,uint256)) project, address admin, address paramsAddr, address randomizer, address projectDataContextAddr, address[] reserves, bool disable, uint256 royalty) returns()
