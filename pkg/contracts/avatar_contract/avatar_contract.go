...
//
// Solidity: function getParamValues(uint256 tokenId) view returns((string,string,string,string,string,string,string,string,string,string,uint256,string,string,string,string) player)
