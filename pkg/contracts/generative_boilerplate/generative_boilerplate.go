...
func (_GenerativeBoilerplate *GenerativeBoilerplateCaller) Projects(opts *bind.CallOpts, arg0 *big.Int) (struct {
	...
	outstruct.MinterNFTInfo = *abi.ConvertType(out[11], new(common.Address)).(*common.Address)
