...
//
// Solidity: function _project() view returns(address _projectAddr, uint256 _projectId, uint24 _maxSupply, uint24 _limit, uint24 _index, uint24 _indexReserve, string _creator, address _creatorAddr, uint256 _mintPrice, address _mintPriceAddr, string _name, (uint256,uint256) _mintingSchedule)
func (_GenerativeNftContract *GenerativeNftContractCaller) Project(opts *bind.CallOpts) (struct {
	...
	outstruct.CreatorAddr = *abi.ConvertType(out[7], new(common.Address)).(*common.Address)
	outstruct.MintPrice = *abi.ConvertType(out[8], new(*big.Int)).(**big.Int)
	outstruct.MintPriceAddr = *abi.ConvertType(out[9], new(common.Address)).(*common.Address)
	outstruct.Name = *abi.ConvertType(out[10], new(string)).(*string)
	outstruct.MintingSchedule = *abi.ConvertType(out[11], new(NFTProjectProjectMintingSchedule)).(*NFTProjectProjectMintingSchedule)
...
// SymbolCol is a free data retrieval call binding the contract method 0x36a0a6cb.
//
// Solidity: function _symbolCol() view returns(string)
func (_GenerativeNftContract *GenerativeNftContractCaller) SymbolCol(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _GenerativeNftContract.contract.Call(opts, &out, "_symbolCol")
...
//
// Solidity: function _symbolCol() view returns(string)
func (_GenerativeNftContract *GenerativeNftContractSession) SymbolCol() (string, error) {
	return _GenerativeNftContract.Contract.SymbolCol(&_GenerativeNftContract.CallOpts)
}

// SymbolCol is a free data retrieval call binding the contract method 0x36a0a6cb.
//
// Solidity: function _symbolCol() view returns(string)
func (_GenerativeNftContract *GenerativeNftContractCallerSession) SymbolCol() (string, error) {
	return _GenerativeNftContract.Contract.SymbolCol(&_GenerativeNftContract.CallOpts)
}
...
// Init is a paid mutator transaction binding the contract method 0xef169be2.
//
// Solidity: function init((address,uint256,uint24,uint24,uint24,uint24,string,address,uint256,address,string,(uint256,uint256)) project, address admin, address paramsAddr, address randomizer, address projectDataContextAddr, address[] reserves, bool disable, uint256 royalty) returns()
func (_GenerativeNftContract *GenerativeNftContractTransactor) Init(opts *bind.TransactOpts, project NFTProjectProjectMinting, admin common.Address, paramsAddr common.Address, randomizer common.Address, projectDataContextAddr common.Address, reserves []common.Address, disable bool, royalty *big.Int) (*types.Transaction, error) {
	return _GenerativeNftContract.contract.Transact(opts, "init", project, admin, paramsAddr, randomizer, projectDataContextAddr, reserves, disable, royalty)
}

// Init is a paid mutator transaction binding the contract method 0xef169be2.
//
// Solidity: function init((address,uint256,uint24,uint24,uint24,uint24,string,address,uint256,address,string,(uint256,uint256)) project, address admin, address paramsAddr, address randomizer, address projectDataContextAddr, address[] reserves, bool disable, uint256 royalty) returns()
func (_GenerativeNftContract *GenerativeNftContractSession) Init(project NFTProjectProjectMinting, admin common.Address, paramsAddr common.Address, randomizer common.Address, projectDataContextAddr common.Address, reserves []common.Address, disable bool, royalty *big.Int) (*types.Transaction, error) {
	return _GenerativeNftContract.Contract.Init(&_GenerativeNftContract.TransactOpts, project, admin, paramsAddr, randomizer, projectDataContextAddr, reserves, disable, royalty)
}

// Init is a paid mutator transaction binding the contract method 0xef169be2.
//
// Solidity: function init((address,uint256,uint24,uint24,uint24,uint24,string,address,uint256,address,string,(uint256,uint256)) project, address admin, address paramsAddr, address randomizer, address projectDataContextAddr, address[] reserves, bool disable, uint256 royalty) returns()
func (_GenerativeNftContract *GenerativeNftContractTransactorSession) Init(project NFTProjectProjectMinting, admin common.Address, paramsAddr common.Address, randomizer common.Address, projectDataContextAddr common.Address, reserves []common.Address, disable bool, royalty *big.Int) (*types.Transaction, error) {
	return _GenerativeNftContract.Contract.Init(&_GenerativeNftContract.TransactOpts, project, admin, paramsAddr, randomizer, projectDataContextAddr, reserves, disable, royalty)
}
