...
//
// Solidity: function projectDetails(uint256 projectId) view returns((uint24,uint24,uint256,address,string,string,address,string,string,string,(string,string,string,string,string),string[],string[],string,uint256,address,string) project)
...
// Mint is a paid mutator transaction binding the contract method 0x4d3fcc1d.
//
// Solidity: function mint((uint24,uint24,uint256,address,string,string,address,string,string,string,(string,string,string,string,string),string[],string[],string,uint256,address,string) project, address[] reserves, bool disable, uint256 openingTime, uint256 royalty) payable returns(uint256)
func (_GenerativeProjectContract *GenerativeProjectContractTransactor) Mint(opts *bind.TransactOpts, project NFTProjectProject, reserves []common.Address, disable bool, openingTime *big.Int, royalty *big.Int) (*types.Transaction, error) {
	return _GenerativeProjectContract.contract.Transact(opts, "mint", project, reserves, disable, openingTime, royalty)
}

// Mint is a paid mutator transaction binding the contract method 0x4d3fcc1d.
//
// Solidity: function mint((uint24,uint24,uint256,address,string,string,address,string,string,string,(string,string,string,string,string),string[],string[],string,uint256,address,string) project, address[] reserves, bool disable, uint256 openingTime, uint256 royalty) payable returns(uint256)
func (_GenerativeProjectContract *GenerativeProjectContractSession) Mint(project NFTProjectProject, reserves []common.Address, disable bool, openingTime *big.Int, royalty *big.Int) (*types.Transaction, error) {
	return _GenerativeProjectContract.Contract.Mint(&_GenerativeProjectContract.TransactOpts, project, reserves, disable, openingTime, royalty)
}

// Mint is a paid mutator transaction binding the contract method 0x4d3fcc1d.
//
// Solidity: function mint((uint24,uint24,uint256,address,string,string,address,string,string,string,(string,string,string,string,string),string[],string[],string,uint256,address,string) project, address[] reserves, bool disable, uint256 openingTime, uint256 royalty) payable returns(uint256)
func (_GenerativeProjectContract *GenerativeProjectContractTransactorSession) Mint(project NFTProjectProject, reserves []common.Address, disable bool, openingTime *big.Int, royalty *big.Int) (*types.Transaction, error) {
	return _GenerativeProjectContract.Contract.Mint(&_GenerativeProjectContract.TransactOpts, project, reserves, disable, openingTime, royalty)
}
